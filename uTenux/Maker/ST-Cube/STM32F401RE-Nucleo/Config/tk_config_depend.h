 ...
 *    Create Date    : 2012/08/28-2017/8/27
...
#define TK_ROM_VECTORAREA_END     0x08000188UL   /* ROM VCETOR table end   392B */
#define TK_ROM_VECTOR_NUMBER              98U    /* ROM VCETOR table size       */
...
#define TK_RAM_VECTORAREA_END     0x20000188UL   /* RAM VCETOR table end   0.4K */
#define TK_RAM_BSSDATAAREA_TOP    0x20000188UL   /* Bss and Data area start     */
...
#define TK_RAM_SYSTEMAREA_END     0x20017000UL   /* Kernel malloc area end  84k */
#define TK_RAM_USERAREA_TOP       0x20017000UL   /* User manual area start      */
#define TK_RAM_USERAREA_END       0x20018000UL   /* User manual area end     4k */
#define TK_RAM_STACKAREA_TOP      0x20018000UL   /* Stack startup area start    */
#define TK_RAM_STACKAREA_END      0x20018000UL   /* Stack startup area end   0k */
#define TK_RAM_TOTALAREA_END      0x20018000UL   /* Total Internal RAM end  96k */
#define TK_RAM_VECTOR_NUMBER              98U    /* RAM VCETOR table size       */
...
#define KNL_CFG_TIMER_CLOCK       84U            /* Timer clock input(MHz)¡ê?select MCK */
...
#define KNL_CFG_BOOT_MESSAGE \
            ...
            "-------------------------------------------------------\n" \
            "                       micro Tenux                     \n" \
            "             Supported MCU is ST STM32F401RE           \n" \
            "                       (build 0400)                    \n" \

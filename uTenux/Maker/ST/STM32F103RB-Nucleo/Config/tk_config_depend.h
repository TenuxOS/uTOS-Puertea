 ...
 *    Create Date    : 2012/7/9-2017/11/02
...
#define TK_ROM_VECTORAREA_END     0x08000130UL   /* ROM VCETOR table end   304B */
#define TK_ROM_VECTOR_NUMBER              76U    /* ROM VCETOR table size       */
...
#define TK_RAM_VECTORAREA_END     0x20000130UL   /* RAM VCETOR table end   0.3k */
#define TK_RAM_BSSDATAAREA_TOP    0x20000130UL   /* Bss and Data area start     */
#define TK_RAM_BSSDATAAREA_END    0x20002000UL   /* Bss and Data area end  7.7k */
#define TK_RAM_SYSTEMAREA_TOP     0x20002000UL   /* Kernel malloc area start    */
#define TK_RAM_SYSTEMAREA_END     0x20004c00UL   /* Kernel malloc area end  11k */
#define TK_RAM_USERAREA_TOP       0x20004c00UL   /* User manual area start      */
#define TK_RAM_USERAREA_END       0x20005000UL   /* User manual area end     1k */
#define TK_RAM_STACKAREA_TOP      0x20005000UL   /* Stack startup area start    */
#define TK_RAM_STACKAREA_END      0x20005000UL   /* Stack startup area end   0k */
#define TK_RAM_TOTALAREA_END      0x20005000UL   /* Total Internal RAM end  20k */
#define TK_RAM_VECTOR_NUMBER              76U    /* RAM VCETOR table size       */
...
#define KNL_CFG_BOOT_MESSAGE \
            ...
            "-------------------------------------------------------\n" \
            "                       micro Tenux                     \n" \
            "             Supported MCU is ST STM32F103RB           \n" \
            "                       (build 0400)                    \n" \

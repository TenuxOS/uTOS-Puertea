 ...
 *    Create Date    : 2013/12/16-2017/11/07
...
#define TK_RAM_SYSTEMAREA_END     0x20009000UL   /* Kernel malloc area end  28k */
#define TK_RAM_USERAREA_TOP       0x20009000UL   /* User manual area start      */
#define TK_RAM_USERAREA_END       0x2000a000UL   /* User manual area end     4k */
#define TK_RAM_UPSTACK_TOP        0x2000a000UL   /* Stack startup area start    */
#define TK_RAM_UPSTACK_END        0x2000a000UL   /* Stack startup area end   0k */
#define TK_RAM_TOTALAREA_END      0x2000a000UL   /* Total Internal RAM end  40k */
...
#define KNL_CFG_TIMER_CLOCK       64U            /* Timer clock input(MHz)£¬select MCK */
...
#define KNL_CFG_BOOT_MESSAGE \
            ...
            "-------------------------------------------------------\n" \
            "                       micro Tenux                     \n" \
            "             Supported MCU is ST STM32F303VC           \n" \
            "                       (build 0380)                    \n" \

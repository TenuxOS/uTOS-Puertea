...
#define APB2PERIPH_BASE       (PERIPH_BASE + (uint32_t)0x00010000)
#define AHB1PERIPH_BASE       (PERIPH_BASE + (uint32_t)0x00020000)
#define AHB2PERIPH_BASE       (PERIPH_BASE + (uint32_t)0x10000000)
...
#define WWDG_BASE             (APB1PERIPH_BASE + (uint32_t)0x2C00)
...
#define USART1_BASE           (APB2PERIPH_BASE + (uint32_t)0x1000)
...
/*!< AHB1 peripherals */
#define GPIOA_BASE            (AHB1PERIPH_BASE + (uint32_t)0x0000)
...
#define RCC_BASE              (AHB1PERIPH_BASE + (uint32_t)0x3800)
#define FLASH_R_BASE          (AHB1PERIPH_BASE + (uint32_t)0x3C00)

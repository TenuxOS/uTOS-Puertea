 ...
 *    Create Date    : 2012/08/28-2017/11/07
...
#define TK_ROM_VECTORAREA_END     0x08000184UL   /* ROM VCETOR table end   388B */
#define TK_ROM_VECTOR_NUMBER              97U    /* ROM VCETOR table size       */
...
#define TK_RAM_VECTORAREA_END     0x20000184UL   /* RAM VCETOR table end   0.4K */
#define TK_RAM_BSSDATAAREA_TOP    0x20000184UL   /* Bss and Data area start     */
...
#define TK_RAM_SYSTEMAREA_END     0x2001b000UL   /* Kernel malloc area end 100k */
#define TK_RAM_USERAREA_TOP       0x2001b000UL   /* User manual area start      */
#define TK_RAM_USERAREA_END       0x2001c000UL   /* User manual area end     4k */
#define TK_RAM_STACKAREA_TOP      0x2001c000UL   /* Stack startup area start    */
#define TK_RAM_STACKAREA_END      0x2001c000UL   /* Stack startup area end   0k */
#define TK_RAM_TOTALAREA_END      0x2001c000UL   /* Total Internal RAM end 112k */
#define TK_RAM_VECTOR_NUMBER              97U    /* RAM VCETOR table size       */
...
#define KNL_CFG_TIMER_CLOCK       120U           /* Timer clock input (MHz)£¬select MCK */
#define KNL_CFG_TIMER_INTLEVEL    0U             /* Timer interrupt level */
#define KNL_CFG_TIMER_PERIOD      10U            /* Timer period,between 1 and 50 */
...
#define KNL_CFG_BOOT_MESSAGE \
            ...
            "-------------------------------------------------------\n" \
            "                       micro Tenux                     \n" \
            "             Supported MCU is ST STM32F207ZG           \n" \
            "                       (build 0400)                    \n" \

/**
  ...
  * @author  MCD Application Team                        Modified by Tenux Wangshb
  * @version V1.8.0                                      V1.8.1
  * @date    04-November-2016                            2017/9/28
...
#elif defined(STM32F410xx) || defined(STM32F411xE) || defined(STM32F401xx)
#if defined(USE_HSE_BYPASS)
      if (pllsource != 0)
      {
        /* HSE used as PLL clock source */
...
#endif /* USE_HSE_BYPASS */  
#endif /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx || STM32F412xG || STM32F413_423xx ||  STM32F446xx || STM32F469_479xx */  
